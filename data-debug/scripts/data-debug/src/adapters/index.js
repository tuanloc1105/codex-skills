import { DataDebugError } from '../core/errors.js';
...
export async function createAdapter(target, credential) {
  switch (target.engine) {
    ...
    case 'redis': return createRedisAdapter(target, credential);
    case 'sqlserver': return createSqlServerAdapter(target, credential);
    default: throw new DataDebugError('UNSUPPORTED_ENGINE', `Unsupported database engine: ${target.engine}`);
  }
}
