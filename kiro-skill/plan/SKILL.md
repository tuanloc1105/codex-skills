...
- Read and respect repository instructions (project `.kiro/steering/*.md`), this agent's own system prompt, learned corrections (`learn_list`), and active safety guardrails.
