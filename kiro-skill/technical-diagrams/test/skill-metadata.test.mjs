...
test('disabled update infrastructure stays outside the ordinary authoring path', () => {
  assert.doesNotMatch(skill, /check-update|update_available|update awareness/i);
