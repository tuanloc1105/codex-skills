...
Claude Code port of the Codex `technical-diagrams` skill. The diagram engine (schemas, renderers, CLI, tests, assets) is carried over verbatim; run its Node CLI and tests through the `Bash` tool.
