...
Technical Diagrams ships a bounded catalogue of 107 commonly used brands for architecture,
...
`node bin/technical-diagrams.mjs brands capture <url> --json`, then author the returned
...
and intended referential use before adding or updating a mark. Technical Diagrams does not
