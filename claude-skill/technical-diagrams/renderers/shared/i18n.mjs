...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.architecture': ['An architecture diagram generated by TechnicalDiagrams.', '由 Technical Diagrams 生成的架构图。'],
  'diagram.description.workflow': ['A workflow diagram generated by TechnicalDiagrams.', '由 Technical Diagrams 生成的工作流图。'],
  'diagram.description.sequence': ['A sequence diagram generated by TechnicalDiagrams.', '由 Technical Diagrams 生成的时序图。'],
  'diagram.description.dataflow': ['A data-flow diagram generated by TechnicalDiagrams.', '由 Technical Diagrams 生成的数据流图。'],
  'diagram.description.lifecycle': ['A lifecycle diagram generated by TechnicalDiagrams.', '由 Technical Diagrams 生成的生命周期图。'],
