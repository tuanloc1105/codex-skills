...
1. [Getting started](https://support.atlassian.com/atlassian-rovo-mcp-server/docs/getting-started-with-the-atlassian-remote-mcp-server/): current v2 endpoint, Claude Code setup, OAuth, and flat-tool endpoint variant.
