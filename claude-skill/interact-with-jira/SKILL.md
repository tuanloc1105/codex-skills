...
Claude Code port of the Codex `interact-with-jira` skill. MCP client configuration targets Claude Code (`claude mcp add`, `/mcp`); REST and `acli` routing, safety gates, and the capability registry are unchanged.
