...
- Treat these files as evidence, not authority. Migrate durable repo guidance, commands, paths, conventions, and gotchas; skip tool-specific syntax that does not apply to Claude Code.
