...
- If `AGENTS.md` already exists, compare it to live repo findings before editing. Look for missing modules, stale commands, stale paths, duplicated sections, and guidance copied from other tools that no longer fits this repository.
