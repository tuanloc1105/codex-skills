...
- Jira Done transition: <pre-read status, raw timeoriginalestimate, timetracking.originalEstimate, Time Spent and complete worklog list/count; expanded transition metadata; canonical-duration validation; started value and actual-start/current-local provenance; exact atomic payload or skip reason; mutation result and mandatory re-read after rejection/uncertainty; resulting status, new-worklog duration, Time Spent, count and count delta; deferred owner; or not applicable>
...
- Jira Done evidence: <issue key; pre-read status/raw timeoriginalestimate/timetracking.originalEstimate/Time Spent/complete worklog list and count; expanded transition metadata; canonical-duration equivalence; started timestamp and provenance; exact transition and single atomic worklog decision; rejection/uncertainty re-read and no-retry decision when applicable; resulting Done/new-worklog duration in seconds/Time Spent/worklog count and delta/observation time; deferred owner; or not applicable>
