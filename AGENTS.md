...
- For Jira Cloud work through Atlassian Rovo MCP, the official Jira REST API, or Atlassian CLI `acli`, read [interact-with-jira/SKILL.md](interact-with-jira/SKILL.md) before configuring access, authenticating, selecting a tool, downloading attachments, or mutating Jira data.
