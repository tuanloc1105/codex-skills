...
6. Before implementation, create or verify the representative branch from `Pilot`, then create or verify the working branch from the representative branch. The representative branch maps to the direct-parent Story or Task; the working branch maps to its Task or Subtask child. Treat the working branch as the MR source and the representative branch as the MR target. Require exact authorization for branch creation, and revalidate branch ancestry before dependent mutation.
